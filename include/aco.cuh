...
__global__ void tour_construction(float *adj_mat, float* attractiveness, int num_nodes, int *d_tours, const int num_ants, float *d_tour_lengths, bool* d_visited, d_unvisited_attractiveness, d_neighbors);
