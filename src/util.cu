...
{
    std::cout << "Usage: " << name << " <filename> <solution> <num ants> <num iter> <alpha> <beta> <rho>" << std::endl;
    std::cout << "\t<filename> - input file as a .tsp file" << std::endl;
    std::cout << "\t<solution> - solution file as a .sol file from the concorde solver" << std::endl;
